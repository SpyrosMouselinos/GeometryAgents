...
class Circle(PointSet):
    ...
    def get_mask(self, corners, out_size, scale, mask_size):
        ...
        rr, cc = draw.ellipse(coors[0], coors[1], int(self.r / scale[0] + mask_size),
                              int(self.r / scale[0] + mask_size), shape=mask.shape)
        # rr, cc = draw.circle(coors[0], coors[1], radius=int(self.r / scale[0] + mask_size), shape=mask.shape)
        rr_c, cc_c = draw.ellipse(coors[0], coors[1], int(self.r / scale[0] + mask_size),
                                  int(self.r / scale[0] - mask_size), shape=mask.shape)
